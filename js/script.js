  ...
  if (player) {
    ...
    playerRow = `<tr>
          ...
          <td align="center" class="align-middle">
            <a href="#" class="btn btn-success mr-3 profile btn-sm" data-toggle="modal" data-target="#userViewModal"
              title="Prfile" data-id="${player.id}"><i class="fa fa-address-card-o" aria-hidden="true"></i></a>
            <a href="#" class="btn btn-warning mr-3 edituser btn-sm" data-toggle="modal" data-target="#userModal"
              title="Edit" data-id="${player.id}"><i class="fa fa-pencil-square-o fa-lg"></i></a>
            <a href="#" class="btn btn-danger deleteuser btn-sm" data-userid="14" title="Delete" data-id="${player.id}"><i
...
function getplayers() {
  ...
  $.ajax({
    url: "https://cmritfriends.herokuapp.com/ajax.php",
    type: "GET",
    dataType: "json",
        ...
        if (player) {
          ...
          const profile = `<div class="row">
                ...
                <div class="col-sm-6 col-md-8">
                  <h4 class="text-success">${player.pname}</h4>
